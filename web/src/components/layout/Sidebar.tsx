...
export function Sidebar() {
    ...
    return (
        <div className="flex h-full w-[280px] flex-col bg-gray-50/50 backdrop-blur-xl border-r border-gray-200/50 dark:bg-black/50 dark:border-white/10">
            <div className="p-6">
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                cn(
                                    ...
                                    isActive
                                        ? "bg-gray-200/50 text-primary dark:bg-white/10 dark:text-white"
